...
export const Route = createFileRoute("/about")({
  head: () => ({ meta: [{ title: "About — Nimbus Bank" }, { name: "description", content: "Learn about the Nimbus Bank digital banking simulation platform." }] }),
  component: About,
});
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold sm:text-5xl">About Nimbus</h1>
        <div className="prose prose-neutral dark:prose-invert mt-8 space-y-6 text-muted-foreground">
          <p>Nimbus Bank is a digital banking management and simulation platform. It's built to demonstrate the shape of a modern retail bank — from onboarding and dashboards to cards, transfers and admin operations — without connecting to any real financial infrastructure.</p>
